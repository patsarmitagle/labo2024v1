...
EXP_CODE = "Experimento_final_semillerio02"
...
CA_catastrophe_default <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$metodo <- "MachineLearning" # MachineLearning EstadisticaClasica Ninguno #Según concluisiones
...
DR_drifting_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$metodo <- "rank_cero_fijo" #segun conclusiones
...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$CanaritosAsesinos1$ratio <- 0.2 # previo a Random Forest según conclusion experimento epico
  param_local$CanaritosAsesinos2$ratio <- 0.1 # post Random Forest según conclusion experimento epico
...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011,
                               202010, 202009, 202008, 202007, 202005, 202004, 202003, 202002, 202001, #ajusto meses a entrenar
...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    lambda_l1 = c(0.0, 1.0), # lambda_l1 >= 0.0
